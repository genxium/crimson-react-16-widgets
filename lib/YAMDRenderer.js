...
function (_React$Component) {
  ...
  function YAMDRenderer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(YAMDRenderer).call(this, props));
    _this.state = {
      dangerousInnerHTML: "",
  ...
  _createClass(YAMDRenderer, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (null != previewableImageList && null == prevProps.previewableImageList) {
        ...
        for (var i in previewableImageList) {
      ...
      if (null != previewableVideoList && null == prevProps.previewableVideoList) {
        ...
        for (var _i in previewableVideoList) {
          if (previewableVideoList[_i] == prevProps.previewableVideoList[_i]) continue;
          anythingChanged = true;
          break;
        }
      }
