...
function () {
  function SingleImageSelectorBundle(props) {
    ...
    this.progressPercentage = undefined === props.progressPercentage || null === props.progressPercentage ? 0.0 : props.progressPercentage; // NOTE: The member `extUploader` COULDN'T be assigned by constructor!
